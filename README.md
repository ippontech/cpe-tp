...
`curl http://ifconfig.io` returns the public IP address of your EC2 instance.

7) Create an SSH key pair by using the following command:
```bash
...
12) To connect through SSH to your instance:
```bash
